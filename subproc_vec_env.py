    ...
    try:
        while True:
            ...
            if cmd == 'step':
                ...
                remote.send((env.observation_space, env.action_space, env.max_episode_steps))
            else:
...
class SubprocVecEnv(VecEnv):
    ...
    def __init__(self, env_fns, spaces=None):
        ...
        self.observation_space, self.action_space, self.max_episode_steps = self.remotes[0].recv()
        self.viewer = None
